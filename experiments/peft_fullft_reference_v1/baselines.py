...
def validate_global_selection(global_path, contract_sha256, artifacts):
    from experiments.peft_fullft_reference_v1.contract import digest
...
def fit_stage(contract_path, output):
    from experiments.peft_fullft_reference_v1.contract import ROOT, digest, read_contract, save_json
