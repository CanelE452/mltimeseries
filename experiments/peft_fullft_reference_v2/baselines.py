...
def validate_global_selection(global_path, contract_sha256, artifacts):
    from experiments.peft_fullft_reference_v2.contract import digest
...
def fit_stage(contract_path, output):
    from experiments.peft_fullft_reference_v2.contract import ROOT, digest, read_contract, save_json
...
def forecast_stage(contract_path, output):
    from experiments.peft_fullft_reference_v2.contract import ROOT, STUDY, digest, read_contract, save_json
    contract = read_contract(contract_path, verify="core")
    contract_hash = digest(contract_path)
