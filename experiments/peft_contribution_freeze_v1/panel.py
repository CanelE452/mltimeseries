"""Study31 panels: original validated loader with explicit four-channel source map."""
import json
...
class Panel:
    def __init__(self, path, stage, smoke=False):
        ...
        expected_channels = {"bdg2": 4, "jena": 4}
        if self.dataset not in expected_channels or self.count_channels != expected_channels[self.dataset]:
            raise ValueError("Use the declared BDG2/Jena four-channel panels")
