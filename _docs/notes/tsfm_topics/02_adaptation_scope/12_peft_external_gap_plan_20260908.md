...
2026-09-08. [반복 탐색 계약](../07_research_direction/11_peft_topic_search_protocol_20260908.md)에 따른 다음 실행이다. 목적은 기존 합성 조건에서 벗어나 실제 수요·전력 예측에서 강한 출력 적응과 단순 회귀를 넘어서는 내부 적응의 효용이 있는지 확인하는 것이다. 이번 비교가 양성이어도 표준 LoRA의 효용이지 새로운 PEFT 방법의 완성은 아니다.
