...
2026-09-09. [계획20](E:/CODING/proj/mltimeseries/_docs/notes/tsfm_topics/20_peft_fullft_reference_plan_20260909.md), [메모리 복구20a](E:/CODING/proj/mltimeseries/_docs/notes/tsfm_topics/20a_peft_fullft_memory_recovery_20260909.md), [활성 단계 검사20b](E:/CODING/proj/mltimeseries/_docs/notes/tsfm_topics/20b_peft_fullft_active_memory_recovery_20260909.md)에 따른 실행이다. 최종 실행은 `peft_fullft_reference_v3`이며 앞선 시도는 보존했다.
...
![성능과 개별 실행](E:/CODING/proj/mltimeseries/results/peft_fullft_reference_v3/figures/scores.png)
...
![실측 시간과 메모리](E:/CODING/proj/mltimeseries/results/peft_fullft_reference_v3/figures/compute_memory.png)
...
근거 파일: [summary.json](E:/CODING/proj/mltimeseries/results/peft_fullft_reference_v3/summary.json), [metrics.csv](E:/CODING/proj/mltimeseries/results/peft_fullft_reference_v3/metrics.csv), [독립 감사](E:/CODING/proj/mltimeseries/runs/peft_fullft_reference_v3/independent_final_audit.json), [리소스 요약](E:/CODING/proj/mltimeseries/runs/peft_fullft_reference_v3/execution_resource_summary.json), [Windows 기록](E:/CODING/proj/mltimeseries/runs/peft_fullft_reference_v3/windows_final.json), [그림 manifest](E:/CODING/proj/mltimeseries/results/peft_fullft_reference_v3/figures/manifest.json).
