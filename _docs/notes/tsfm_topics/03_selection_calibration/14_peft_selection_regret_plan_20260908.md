...
2026-09-08. [13번 결과](../02_adaptation_scope/13_peft_temporal_replication_results_20260908.md)에서 현재 A 분기를 닫은 뒤 작성했다. 아직 예측하지 않은 후보의 미래 성능을 열기 전에 이 계획을 고정한다. 이미 선택된 일부 후보의 성능은 12·13에서 보았으므로 이번은 개발 자료를 이용한 탐색적 진단이다. 새 방법의 확증으로 부르지 않는다.
