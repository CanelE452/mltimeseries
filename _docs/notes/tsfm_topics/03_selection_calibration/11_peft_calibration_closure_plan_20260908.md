...
2026-09-08. [반복 탐색 계약](../07_research_direction/11_peft_topic_search_protocol_20260908.md)의 첫 실행이다. GPU 재학습 없이 10번의 기존 val/eval 예측을 CPU에서 분석한다. 10번 평가를 이미 봤으므로 개발용 탐색이며 새로운 확인 실험이 아니다. 이번 결과만으로 C 전체를 기각하지 않는다.
