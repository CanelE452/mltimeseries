...
Created: 2026-09-11T07:07:41.808872+00:00
...
real-data support from old records     WARN/FAIL
...
full train transition excess risk mean  0.0120%
origin-only transition excess mean      0.2457%
quadratic latest-value excess mean      0.2457%
```
...
The old `covariate-trust-pilot` record adds a realism warning. It found no M5 or Favorita series with `|rho_interval| >= 0.8`; interval dependence in those real data was much weaker than the strong synthetic regimes. That means even a fixed version of this synthetic gate still needs a train-only real-data availability check before a paper-scale claim.
